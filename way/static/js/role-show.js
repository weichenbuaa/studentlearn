var RoleShow = function () {
    ...
    return {
        ...
        init: function () {
            ...
            var oTable = $('#role_editable_1').dataTable({
                "aLengthMenu": [
                    [5, 15, 20, -1],
            ...
            $('#role_editable_1 a.delete').live('click', function (e) {
                e.preventDefault();
            ...
            $('#role_editable_1 a.cancel').live('click', function (e) {
                e.preventDefault();
